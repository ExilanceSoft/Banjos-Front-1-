...
const AppHeader = () => {
  ...
  return (
    <CHeader position="sticky" className="bg-white mb-4 p-0" ref={headerRef}>
        ...
        <CHeaderNav className="ms-auto ms-md-0 text-dark">
          ...
          <CDropdown variant="nav-item" placement="bottom-end">
            <CDropdownToggle caret={false}>
              <CIcon icon={cilLanguage} size="lg" style={{ color: 'black' }} />
            </CDropdownToggle>
            <CDropdownMenu className="text-dark">
              ...
              >
                <CIcon className="me-2" icon={cifGb} size="lg" style={{ color: 'black' }} /> English
              </CDropdownItem>
            </CDropdownMenu>
          </CDropdown>
          ...
          <CDropdown variant="nav-item" placement="bottom-end">
            <CDropdownToggle caret={false}>
              {colorMode === 'dark' ? (
                <CIcon icon={cilMoon} size="lg" style={{ color: 'black' }} />
              ) : colorMode === 'auto' ? (
                <CIcon icon={cilContrast} size="lg" style={{ color: 'black' }} />
              ) : (
                <CIcon icon={cilSun} size="lg" style={{ color: 'black' }} />
              )}
            </CDropdownToggle>
            <CDropdownMenu className="text-dark">
              <CDropdownItem
