            ...
            <div style={{
              ...
              >
                {testimonials[currentTestimonial]?.image && (
                  <img 
                    src={`http://64.227.163.17:8000${testimonials[currentTestimonial].image}`}
            ...
            <div style={{ paddingTop: '2.5rem' }}>
              ...
              <div>
                ...
                {testimonials[currentTestimonial]?.rating && (
                  <div style={{ margin: '0.5rem 0', color: '#f6ad55' }}>
              ...
              {testimonials.map((_, index) => (
                <motion.button
                  ...
                  style={{
                    ...
                    height: '0.75rem',
                    borderRadius: '9999px',
                    backgroundColor: index === currentTestimonial ? '#f6ad55' : '#e2e8f0',
                    border: 'none',
                    cursor: 'pointer',
                    padding: 0,
